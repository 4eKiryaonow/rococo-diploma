package qa.guru.rococo_museum.service.api;
...
import qa.guru.rococo_museum.ex.NoRestResponseException;
import qa.guru.rococo_museum.model.CountryJson;
...
public class RestGeoClient {
    ...
    public RestGeoClient(RestTemplate restTemplate, @Value("${rococo-geo.base-uri}") String rococoGeoApiUri) {
        ...
        this.rococoGeoApiUri = rococoGeoApiUri + "/api/country";
    }
